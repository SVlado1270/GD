...
public class CardManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InstantiateCard("Draw",             CardFlavour.Skill,  "silent2",              "Draw two cards.",                                                      1,      new Effect(TargetType.Player) { cardsToDraw = 2 },                   CardState.Locked,       1);
        ...
        InstantiateCard("Blade Dance",      CardFlavour.Skill,  "add3shivs",            "Add 3 shivs into your hand",                                           1,      new Effect(TargetType.Player) { shivsToSpawn = 3 },                  CardState.Locked,       2);
